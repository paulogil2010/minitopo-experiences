...
do
    ...
    do
        ...
        slossU=$(cat $sub/https/0/netstat_server_after | egrep -i -A 10 'TcpExt\:' | grep loss | awk -F' ' '{print $1}')
        ...
        slossM=$(cat $sub/https/1/netstat_server_after | egrep -i -A 10 'TcpExt\:' | grep loss | awk -F' ' '{print $1}')
